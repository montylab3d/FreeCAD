...
PyObject *Application::sCheckLinkDepth(PyObject * /*self*/, PyObject *args)
{
    ...
    PY_TRY {
        return Py::new_reference_to(Py::Long(GetApplication().checkLinkDepth(depth,false)));
    }PY_CATCH;
}
...
PyObject *Application::sSetActiveTransaction(PyObject * /*self*/, PyObject *args)
{
    ...
    PY_TRY {
        Py::Long ret(GetApplication().setActiveTransaction(name,PyObject_IsTrue(persist)));
        return Py::new_reference_to(ret);
    }PY_CATCH;
}
